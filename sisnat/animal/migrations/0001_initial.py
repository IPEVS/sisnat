    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidade_de_medida', models.CharField(choices=[('BOA', 'Boa'), ('ÓTIMA', 'Ótima'), ('REGULAR', 'Regular'), ('RUIM', 'Ruim'), ('PÉSSIMA', 'Péssima')], default='BOA', max_length=7, verbose_name='Condição Física')),
